defmodule SymphonyElixir.StatusDashboard do
  ...
  defp humanize_codex_event(:elicitation_auto_declined, _message, payload) do
    message = map_path(payload, ["params", "message"]) || map_path(payload, [:params, :message])

    if is_binary(message) do
      "MCP elicitation auto-declined: #{inline_text(message)}"
    else
      "MCP elicitation auto-declined"
    end
  end
